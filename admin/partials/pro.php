<div class="wow-admin-col">	
	<div class="wow-admin-col-12">
		...
		<a href="https://wow-estore.com/item/slide-menu-pro/" target="_blank" class="wow-btn">GET PRO VERSION <i class="fa fa-download"></i></a> <a href="https://wow-estore.com/item-preview/slide-menu-pro/" target="_blank" class="wow-btn">DEMO PRO VERSION <i class="fa fa-eye"></i></a>
		</p>
	</div>	
</div>
...
<div class="wow-admin-col" style="font-size:18px;">
	...
	<div class="wow-admin-col-12 wow-futures">			
		<ul>
			...
			<li>4 Positions of menu</li>
			<li>8 Positions of menu button</li>
			<li>Choose colors for the menu design</li>
			<li>Add the awesome icons to each element</li>
			<li>Insert the links and other navigation elements</li>
			<li>Set the bright background for the menu button and the item titles</li>
...
<p style="font-size:18px;">We will be very grateful if you <a href="https://wordpress.org/plugins/slide-menu/" target="_blank"><b/>leave a review about the plugin</b></a>.</p>
